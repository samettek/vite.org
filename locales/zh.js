  ...
  superNodes: {
    ...
    'contents': [{
      ...
      'answer': [
        ...
        '8、社交媒体曝光。强有力的媒体曝光将决定您对社区的投入程度。<br/>资料提交表单链接：<a href="https://jiandaoyun.com/f/5bdbef8be1613237783c264b" target="_blank">https://jiandaoyun.com/f/5bdbef8be1613237783c264b</a>'
      ]
    }, {
      'orderNum': '二、',
      ...
      'question': '激励方案',
      'answer': [
        '1、测试网络阶段的超级节点奖励总额度为，VITE总发行量的3%，即3000万VITE。',
        '2、超级节点奖励分两部分，50%奖励出块，50%奖励投票。即每年的3000万奖励中，1500万奖励给所有出块超级节点，1500万奖励给所有被投票超级节点（测试网络阶段为前100个超级节点）。<br/>一个挖矿超级节点如果持续挖矿1年，可以获得60万的VITE的出块奖励（ （3000万/25个节点）*50%），另外还可以获得一份投票奖励。投票奖励计算，按照该超级节点的质押和投票占比，即（该节点抵押数+投票数）/（所有超级节点的抵押数+投票数）*出块奖励，每一轮（75秒）计算，再每天汇总与出块率相乘。<br/>单个超级节点折算成每天收益为，1643.835VITE的投票奖励+抵押和投票所占比例的投票奖励',
